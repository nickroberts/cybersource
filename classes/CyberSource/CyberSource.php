<?php
	...
	class CyberSource {
		...
		const ENV_TEST = 'https://ics2wstest.ic3.com/commerce/1.x/transactionProcessor/CyberSourceTransaction_1.98.wsdl';
		const ENV_PRODUCTION = 'https://ics2ws.ic3.com/commerce/1.x/transactionProcessor/CyberSourceTransaction_1.98.wsdl';

		const VERSION = '0.4';
		const API_VERSION = '1.98';
